...
do
    ...
    do
        ...
        tts --text "$test_phrase" --model_path $model_path$lr"/checkpoint_"$cp".pth" --config_path $model_path$lr"/config.json" --out_path $out_path$lr$cp".wav" --vocoder_name $vocoder_name
    done
done
